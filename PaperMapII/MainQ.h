...
typedef enum  {MESSAGELABEL,SPEEDLABEL,ALTITUDELABEL,TRIPMETER,MAPLEVEL,MAPSOURCE,GPSTRACKPOIBOARD,DRAWINGBOARD,PREDRAW} ITEMID;  //no more than ten times here
